...
describe('PegasysV2Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as PegasysV2Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('PegasysV2Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('PegasysV2Pool')
