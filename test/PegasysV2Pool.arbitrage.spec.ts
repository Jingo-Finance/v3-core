...
import { PegasysV2PoolSwapTest } from '../typechain/PegasysV2PoolSwapTest'
...
describe('PegasysV2Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('PegasysV2PoolSwapTest')
            const tester = (await testerFactory.deploy()) as PegasysV2PoolSwapTest
          ...
          let tester: PegasysV2PoolSwapTest
