...
describe('PegasysV2Pool', () => {
  ...
  let pool0: MockTimePegasysV2Pool
  let pool1: MockTimePegasysV2Pool
  ...
  let swapTargetCallee: TestPegasysV2Callee
  let swapTargetRouter: TestPegasysV2Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimePegasysV2Pool, any]> => {
