...
describe('PegasysV3Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as PegasysV3Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('PegasysV3Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('PegasysV3Pool')
