...
describe('JingoV3Factory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as JingoV3Factory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('JingoV3Pool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('JingoV3Pool')
